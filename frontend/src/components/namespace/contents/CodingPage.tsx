...
export const CodingPage = () => {
    ...
    const {activeDoc, setActiveDoc, getYDoc, isDocPopulated, setIsDocPopulated} = useYjs({socket, selectedFile});
    ...
    const onSelect = (file: File) => {
        ...
        if (file.type === Type.DIRECTORY) {
            ...
            setIsDocPopulated(false); 
            setSelectedFile(file);

            let doc = getYDoc(file.path);
            setActiveDoc(doc);
    ...
    useEffect(() => {
        if (selectedFile && activeDoc === null) {
